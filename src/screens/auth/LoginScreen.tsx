...
export default function LoginScreen({navigation}:any){
 ...
 return <View style={{flex:1,padding:24,justifyContent:"center",backgroundColor:theme.colors.background}}>
  <Text style={{fontSize:42,fontWeight:"900",color:theme.colors.primary,letterSpacing:-0.5}}>Bounty</Text><Text style={styles.subtitle}>Generous Abundance of Food</Text>
